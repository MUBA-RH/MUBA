...
def match(message, context):
 ...
 keys=('group memory','community memory','community knowledge','group knowledge','official knowledge difference','grup hafız','topluluk bilg','群体记忆','群组记忆','ذاكرة المجموعة','ذاكرة المجتمع','समूह स्मृति','सामुदायिक स्मृति')
